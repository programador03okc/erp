                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="id_doc_identidad"
                                            onchange="evaluarDocumentoSeleccionado(event);" required>
                                            <option value="0" disabled>Elija una opción</option>
                                            @foreach ($sis_identidad as $tp)
                                                @if ($tp->id_doc_identidad === 2)
                                                    <option value="{{ $tp->id_doc_identidad }}" selected>
                                                        {{ $tp->descripcion }}</option>
                                                @else
                                                    <option value="{{ $tp->id_doc_identidad }}">{{ $tp->descripcion }}
                                                    </option>
                                                @endif
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div style="display:flex;">
                                            ...
                                            <input type="text" class="form-control" name="name_ubigeo"
                                                readonly="">
                                            <button type="button" title="Seleccionar Ubigeo" class="btn-primary"
                                                onclick="ubigeoModalProveedor();"><i
                                        ...
                                        <div id="panel_consulta_sunat" class="panel panel-default invisible">
                                            <div class="panel-heading" role="tab" id="collapseListGroupHeading1">
                                                <h4 class="panel-title">
                                                    <a href="#collapseListGroup1" class="" role="button"
                                                        ...
                                                        <h6><strong>Razon Social:</strong><img width="10px"
                                                                src="{{ asset('images/loading.gif') }}"
                                                                class="loading invisible"> <span
                                                                name="razon_social"></span> <strong>RUC:<img
                                                                    width="10px"
                                                                    src="{{ asset('images/loading.gif') }}"
                                                                    class="loading invisible"> </strong>[<span
                                                                name="numero_ruc"></span>]
                                                            <strong>Condicion:</strong><img width="10px"
                                                                src="{{ asset('images/loading.gif') }}"
                                                                class="loading invisible"> <span name="condicion"
                                                                class="label label-default"></span> <strong>Estado:<img
                                                                    width="10px"
                                                                    src="{{ asset('images/loading.gif') }}"
                                                                    class="loading invisible"> </strong> <span
                                                                name="estado" class="label label-default"></span>
                                                        </h6>
                                                    </a>
                                                </h4>
                                            </div>
                                            <div class="panel-collapse collapse" role="tabpanel"
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item">
                                                        <h6><strong>Fecha Actividad:</strong> <span
                                                                name="fecha_actividad"></span></h6>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <h6><strong>Tipo:</strong> <span name="tipo"></span></h6>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <h6><strong>Fecha Inscripción:</strong> <span
                                                                name="fecha_inscripcion"></span></h6>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <h6><strong>Domicilio:</strong> <span name="domicilio"></span>
                                                        </h6>
                                                    </li>
                                                    <li class="list-group-item">
