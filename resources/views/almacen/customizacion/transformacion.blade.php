                ...
                <h4 style="display:flex;justify-content: space-between;">
                    ...
                    <div style="display:flex;padding-right: 0px;">
                        ...
                        <button type="button" class="btn btn-warning btn-sm btn-flat" onClick="openIniciar();" data-toggle="tooltip" data-placement="bottom" title="Iniciar Transformación">
                            Iniciar <i class="fa fa-step-forward"></i> </button>
                        <button type="button" class="btn btn-success btn-sm btn-flat" onClick="openProcesar();" data-toggle="tooltip" data-placement="bottom" title="Procesar Transformación">
                            Finalizar <i class="fa fa-step-forward"></i> </button>
                    </div>
                </h4>
            </div>
        </div>
                        ...
                        <thead>
                            <tr style="background: lightcoral;">
                                ...
                                <th width='8%' style="padding:0px;">
                                    <i class="fa fa-plus-square icon-tabla green boton add-new-sobrante" id="addSobrante" data-toggle="tooltip" data-placement="bottom" title="Agregar Producto" onClick="agregar_producto_sobrante();"></i>
                                </th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                        ...
                        <thead>
                            <tr style="background: lightgray;">
                                ...
                                <th style="padding:0px;">
                                    <i class="fa fa-plus-square icon-tabla green boton add-new-servicio" id="addServicio" data-toggle="tooltip" data-placement="bottom" title="Agregar Servicio"></i>
                                </th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    ...
                    <table id="listaCostosIndirectos" class="table">
                        <thead>
                            <tr style="background: navajowhite;">
                                ...
                                <th>Total</th>
                                <th style="padding:0px;">
                                    <i class="fa fa-plus-square icon-tabla green boton add-new-indirecto" id="addCostoIndirecto" data-toggle="tooltip" data-placement="bottom" title="Agregar Indirecto"></i>
                                </th>
                            </tr>
                        </thead>
                        <tbody></tbody>
