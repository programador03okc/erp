$(function () {
    ...
    $('#formulario').on('submit', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: route('gerencial.fondos.guardar'),
            data: data,
            dataType: 'JSON',
    ...
    $('#formulario-cobro').on('submit', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: route('gerencial.fondos.guardar-cobro'),
            data: data,
            dataType: 'JSON',
            success: function(response) {
                $('#tabla').DataTable().ajax.reload();
    ...
    $('#tabla').on('click', 'button.editar', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: route('gerencial.fondos.cargar-cobro'),
    ...
    $('#tabla').on('click', 'button.eliminar', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'POST',
                    url: route('gerencial.fondos.eliminar'),
                    data: {id: $(e.currentTarget).data('id')},
                    dataType: 'JSON',
                    success: function(response) {
                        $('#tabla').DataTable().ajax.reload();
...
function listar() {
    ...
    const $tabla = $('#tabla').DataTable({
        ...
        order: [[0, 'asc']],
        ajax: {
            url: route('gerencial.fondos.listar'),
            method: 'POST',
...
function exportarExcel() {
    window.open(route('gerencial.fondos.exportar-excel'));
}
