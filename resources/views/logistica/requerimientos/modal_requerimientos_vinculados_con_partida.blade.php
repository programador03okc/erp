                    ...
                    <table class="table table table-condensed table-bordered" id="tablaResumenRequerimientoVinculadosConPartida">
                        <thead>
                            <tr>
                                ...
                                <th>Total de partidas de requerimientos aprobados</th>
                                <th>Total de partidas de requerimientos aprobados <small>(incl. IGV)</small></th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr style="text-align: center;">
                                <td><span id="ppto_partida_anual">...</span></td>
                                <td><span id="ppto_partida_mes">...</span></td>
                                <td><span id="total_partida_de_requerimientos_aprobados">...</span></td>
                                <td><span id="total_partida_de_requerimientos_aprobados_incluido_igv">...</span></td>
                            </tr>
                        </tbody>
                    </table>
                    </div>
                                ...
                                <table class="table table-condensed table-bordered table-okc-view" id="tablaRequerimientosVinculadosConPartida" style="width:100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align:center;">Importe incl. IGV</th>
