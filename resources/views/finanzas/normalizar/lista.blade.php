...
@section('cuerpo')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="division" required>
                                        @foreach ($division as $key => $item)
                                            @if ($key === 0)
                                                <option value="{{ $item->id_division }}" selected>{{ $item->descripcion }}
                                                </option>
                                            @else
    ...
    <!-- Modal -->
    <div class="modal fade" id="normalizar-partida" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-vista-rapida-requerimiento-pago"
                                    ...
                                    <table class="table" border="0" id="tablaDatosGenerales">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="width:5%; font-weight:bold; text-align:right;">Grupo/División
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:14%; font-weight:bold; text-align:right;">Fecha Registro
                                                </td>
                                            ...
                                            <tr>
                                                <td style="width:5%; font-weight:bold; text-align:right;">Solicitado por
                                                </td>
                                                ...
                                                <td style="width:5%; font-weight:bold; text-align:right;">Tipo Impuesto
                                                </td>
                                                <td id="tipo_impuesto" style="width:5%;"></td>
                                                <td style="width:10%; font-weight:bold; text-align:right;">Archivos
                                                    adjuntos</td>
                                                <td id='adjuntosRequerimientoPago'>-</td>
                                                <td></td>
                                            </tr>
                                            <tr class="oculto" id="contenedor_presupuesto_old">
                                                <td style="width:5%; font-weight:bold; text-align:right;">Presupuesto
                                                    <em>(Proy)</em></td>
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="table" border="0" id="tablaDatosDestinatario">
                                        <tbody>
                                            <tr>
                                                <td style="width:5%; font-weight:bold; text-align:right;">Tipo Destinatario
                                                </td>
                                                <td id="tipo_destinatario" style="width:5%;"></td>
                                                <td style="width:5%; font-weight:bold; text-align:right;">Nombre
                                                    destinatario</td>
                                                <td id="destinatario" style="width:10%;"></td>
                                                <td id="tipo_documento_destinatario"
                                                    style="width:5%; font-weight:bold; text-align:right;">Doc.</td>
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-condensed table-bordered"
                                        id="listaDetalleRequerimientoPago">
                                        <thead>
                                            <tr>
                                                <th style="width: 2%">#</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-right"><span name="simbolo_moneda">S/</span><label
                                                        name="total"> 0.00</label></td>
                                                <td></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <fieldset class="group-importes">
                                ...
                                <div class="box box-widget">
                                    <div class="box-body">
                                        <table class="table table-striped table-bordered" id="listaPartidasActivas"
                                            width="100%">
                                            <thead>
                                                <tr>
                                                    <th width="10">Codigo</th>
                                                    <th width="70">Descripción</th>
                                                    <th width="10" style="background-color: #ddeafb;">Presupuesto
                                                        Total</th>
                                                    <th width="10" style="background-color: #ddeafb;">Presupuesto Mes
                                                        <small>(actual)</small></th>
