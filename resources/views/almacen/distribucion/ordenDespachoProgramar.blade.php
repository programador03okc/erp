        ...
        <div class="modal-content">
            <form id="form-despacho_fecha_programada">
                ...
                <div class="modal-footer">
                    ...
                    id="btnDespachoObsAnular" onClick="anularDespachoInterno();" >Quitar despacho</button>
                    <button type="button" class="btn btn-sm btn-success" 
                    id="btnDespachoObsGenerar" onClick="generarDespachoInterno();" >Programar despacho</button>
                </div>
            </form>
        </div>
    </div>
