...
@section('cabecera') Crear Cliente @endsection
...
<div class="page-main" type="usuarios">
    <form action="{{route('gerencial.cobranza.crear-clientes')}}" data-form="guardar-cliente" type="POST" enctype="multipart/formdata">
