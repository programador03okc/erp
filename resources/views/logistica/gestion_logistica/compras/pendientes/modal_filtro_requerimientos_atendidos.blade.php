<div class="modal fade" tabindex="-1" role="dialog" id="modal-filtro-requerimientos-atendidos">
    <div class="modal-dialog" style="width: 38%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-horizontal" id="formFiltroListaRequerimientosAtendidos">
                    ...
                    <div class="container-filter" style="margin: 0 auto;">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm handleChangeFiltroEmpresa handleChangeUpdateValorFiltroRequerimientosAtendidos" name="empresa" readOnly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm handleChangeUpdateValorFiltroRequerimientosAtendidos" name="sede" readOnly>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="date" name="fechaRegistroDesde" class="form-control handleBlurUpdateValorFiltroRequerimientosAtendidos" readOnly>
                                    <small class="help-block">Desde (dd-mm-aaaa)</small>
                                </div>
                                <div class="col-sm-4">
                                    <input type="date" name="fechaRegistroHasta" class="form-control handleBlurUpdateValorFiltroRequerimientosAtendidos" readOnly>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                <select class="form-control input-sm handleChangeUpdateValorFiltroRequerimientosAtendidos" name="reserva" readOnly>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                <select class="form-control input-sm handleChangeUpdateValorFiltroRequerimientosAtendidos" name="orden" readOnly>
