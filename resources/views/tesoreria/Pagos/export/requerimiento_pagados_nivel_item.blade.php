<table>
    ...
    <tr>
            ...
            <th colspan="5" style="background-color:#cccccc;">Partida (ppto. interno) </th>
        ...
        <tr>
            ...
            <th style="background-color:#cccccc;" width="10">Cod.sub Partida</th>
            <th style="background-color:#cccccc;" width="20">Des.sub Partida</th>
            <th style="background-color:#cccccc;" width="10">Presupuesto total en soles</th>
            <th style="background-color:#cccccc;" width="10">Presupuesto mes en soles (fecha registro)</th>
        </tr>
    </thead>
    <tbody>
        @foreach ($data as $item)
                <tr>
                    ...
                    <td>{{ $item->presupuesto_interno_total_partida }}</td>
                    <td>{{ $item->presupuesto_interno_mes_partida }}</td>
                    ...
                    <td>{{ date('H:i:s', strtotime($item->fecha_registro)) }}</td>
