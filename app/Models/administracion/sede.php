...
class Sede extends Model
{
    ...
    public static function listarSedesPorEmpresa($idEmpresa)
    {
        $data = Sede::select(
            ...
            DB::raw("(SELECT id_almacen FROM almacen.alm_almacen WHERE alm_almacen.id_sede = sis_sede.id_sede and alm_almacen.id_tipo_almacen = 1  ORDER BY alm_almacen.fecha_registro desc limit 1) AS id_almacen")
