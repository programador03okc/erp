    ...
    mostrarDetalleRequerimiento(data, hasDisabledInput) {
        ...
        for (let i = 0; i < dataDetalleRequerimiento.length; i++) {
            ...
            if (dataDetalleRequerimiento[i].id_partida > 0) {
                ...
                totalSaldoMes = dataDetalleRequerimiento[i].presupuesto_interno_saldo_mes_disponible_partida != null ? dataDetalleRequerimiento[i].presupuesto_interno_saldo_mes_disponible_partida : 0;
                totalPorConsumidoConIgvFaseAprobacion=dataDetalleRequerimiento[i].total_consumido_hasta_fase_aprobacion_con_igv>0 ?(dataDetalleRequerimiento[i].total_consumido_hasta_fase_aprobacion_con_igv):0;
            }
            ...
            if (tbodyChildren[index].querySelector("p[class='descripcion-partida']") !=null && tbodyChildren[index].querySelector("p[class='descripcion-partida']").dataset.idPartida > 0) {
                if (!partidaAgregadas.includes(tbodyChildren[index].querySelector("p[class='descripcion-partida']").dataset.idPartida)) {
                    ...
                    tempPartidasActivas.push({
                        ...
                        'codigo': tbodyChildren[index].querySelector("p[class='descripcion-partida']").textContent,
                        'descripcion': tbodyChildren[index].querySelector("p[class='descripcion-partida']").title,
                        ...
                        'total_por_consumido_con_igv_fase_aprobacion': tbodyChildren[index].querySelector("p[class='descripcion-partida']").dataset.totalPorConsumidoConIgvFaseAprobacion!=null?parseFloat(tbodyChildren[index].querySelector("p[class='descripcion-partida']").dataset.totalPorConsumidoConIgvFaseAprobacion.replace(/,/gi, '')):0,
                        'saldo_total': 0,
                        'saldo_mes': 0
                    });
                }
        ...
        for (let p = 0; p < tempPartidasActivas.length; p++) {
            if (tempPartidasActivas[p].id_moneda_presupuesto_utilizado == 2) { // moneda dolares
                ...
                if(document.querySelector("input[name='id_requerimiento']").value >0){
                    ...
                    tempPartidasActivas[p].saldo_total = parseFloat((tempPartidasActivas[p].presupuesto_total)) - (parseFloat(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion) >0 ? parseFloat(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion): (parseFloat(tempPartidasActivas[p].presupuesto_utilizado_al_cambio)>0? parseFloat(tempPartidasActivas[p].presupuesto_utilizado_al_cambio):0));
                    tempPartidasActivas[p].saldo_mes = parseFloat((Util.formatoNumero(tempPartidasActivas[p].total_saldo_mes_disponible,2,'.',''))) - (parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.','')) >0 ? parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.','')): 0) - (parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_utilizado_al_cambio,2,'.',''))>0? parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_utilizado_al_cambio,2,'.','')):0);
                }else{
                    tempPartidasActivas[p].saldo_total = parseFloat((Util.formatoNumero(tempPartidasActivas[p].presupuesto_total,2,'.',''))) - (presupuesto_utilizado_alCambio > 0 ? presupuesto_utilizado_alCambio : 0) - (Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.',''));
                    tempPartidasActivas[p].saldo_mes = parseFloat((Util.formatoNumero(tempPartidasActivas[p].total_saldo_mes_disponible,2,'.',''))) - ((presupuesto_utilizado_alCambio) > 0 ? presupuesto_utilizado_alCambio : 0) - (Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.',''));

                }
            } else {
                if(document.querySelector("input[name='id_requerimiento']").value >0){
                    tempPartidasActivas[p].saldo_total = ( parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_total,2,'.',''),2))  - (parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.','')) >0 ? parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.',''),2):0) -  (parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_utilizado,2,'.',''))>0? parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_utilizado,2,'.',''),2):0);
                    tempPartidasActivas[p].saldo_mes = ( parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_saldo_mes_disponible,2,'.',''),2))  - (parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.','')) >0 ?parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.',''),2): 0) - (parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_utilizado,2,'.',''))>0? parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_utilizado,'.',''),2):0);
                }else{
                    tempPartidasActivas[p].saldo_total = ( parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_total,2,'.',''),2)) - (parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_utilizado,2,'.','')) > 0 ? parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_utilizado,2,'.','')) : 0) - parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.',''),2);
                    tempPartidasActivas[p].saldo_mes = (parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_saldo_mes_disponible,2,'.',''),2)) - (parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_utilizado,2,'.','')) > 0 ? parseFloat(Util.formatoNumero(tempPartidasActivas[p].presupuesto_utilizado,2,'.','')) : 0) - (parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.',''))>0? parseFloat(Util.formatoNumero(tempPartidasActivas[p].total_por_consumido_con_igv_fase_aprobacion,2,'.',''),2):0);
                }
