...
@section('cabecera') Marcas @endsection
                ...
                <div class="box box-danger">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <button class="btn btn-success" data-button="nuevo" type="button"><i class="fa fa-plus"></i> Nueva marca</button>
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <table class="mytable table table-condensed table-bordered table-okc-view"
                                            id="lista-marcas" style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th hidden></th>
                                            <th>codigo</th>
...
<div id="nuevo" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{route('cas.garantias.marca.guardar')}}" method="POST" data-form="guardar" >
...
<div id="editar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{route('cas.garantias.marca.actualizar')}}" method="POST" data-form="actualizar" >
                <input type="hidden" name="id" value="">
                <div class="modal-header">
                    <h5 class="modal-title" id="my-modal-title">Editar Marca</h5>
                    <button class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<script src="{{ asset('js/cas/cas_marcas/marcas.js') }}"></script>


<script>
    const route_listar = "{{ route('cas.garantias.marca.listar') }}";
    const route_editar = "{{ route('cas.garantias.marca.editar') }}";
