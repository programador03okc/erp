...
function listar() {
    ...
    $('#lista-marcas').DataTable({
        ...
        'columns': [
            { 'data': 'id_cas_marca', 'name': 'id_cas_marca'},
            { 'data': 'id_cas_marca', 'name': 'id_cas_marca',
                    ...
                    function (data, type, row) {
                        return `
                            <div class="btn-group" role="group">
                                ...
                                data-placement="bottom" data-id="${row['id_cas_marca']}" title="Editar registro" >
                                <i class="fas fa-edit"></i></button>

                                <button type="button" class="anular btn btn-danger boton" data-toggle="tooltip"
                                data-placement="bottom" data-id="${row['id_cas_marca']}" title="Anular registro" >
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            if (result.value.status===200) {
                $('#nuevo').modal('hide');
                $('#lista-marcas').DataTable().ajax.reload();
                Swal.fire({
                    title: 'Éxito',
