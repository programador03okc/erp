...
<div class="option-function">
    ...
    <button type="submit" class="btn-okc" id="btnGuardar-disabled" disabled><i class="fas fa-save fa-lg"></i> Guardar</button>
    <button type="submit" class="btn-okc" id="btnEditar-disabled" disabled><i class="fas fa-edit fa-lg"></i> Editar</button>
    <button type="submit" class="btn-okc" id="btnAnular-disabled" disabled><i class="fas fa-trash fa-lg"></i> Anular</button>
    ...
    @if (!empty($modulo))
        @switch($modulo)
            @case('necesidades')
                ...
                <button type="button" class="btn-okc" id="btnNuevo-disabled" disabled><i class="fas fa-file fa-lg"></i> Nuevo</button>
                @endif
                ...
                <button type="button" class="btn-okc" id="btnCopiar-disabled" disabled ><i class="fas fa-copy fa-lg"></i> Copiar</button>
                @endif
