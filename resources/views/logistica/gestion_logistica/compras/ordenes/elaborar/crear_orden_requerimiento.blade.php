            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 style="display:flex;justify-content: space-between;">General &nbsp;
                        <div>
                            <span style="color:blue;" name="codigo_orden_interno"></span> &nbsp; <span
                                style="font-size:small;" name="estado_orden"></span>
                        </div>
                        <div>
                            @if (in_array(284, $array_accesos))
                                <button type="button" name="btn-imprimir-orden-pdf"
                                    class="btn btn-info btn-sm handleClickImprimirOrdenPdf" title="Imprimir orden en .pdf"
                                    disabled><i class="fas fa-print"></i> Imprimir</button>
                            @endif
                            @if (in_array(285, $array_accesos))
                                <button type="button" name="btn-migrar-orden-softlink"
                                    class="btn btn-warning btn-sm handleClickMigrarOrdenASoftlink"
                                    title="Migrar orden a softlink" disabled><i class="fad fa-clone"></i> Migrar Orden a
                                    soflink</button>
                            @endif
                            <button type="button" name="btn-enviar-email-finalizacion-cuadro-presupuesto"
                                class="btn btn-default btn-sm handleClickEstadoCuadroPresupuesto oculto"
                                id="btn-enviar-email-finalizacion-cuadro-presupuesto"
                                style="background-color: #9b659b; color:#fff;" title="Enviar email finalización CDP"><i
                                    class="fas fa-info-circle"></i> Estado CDP</button>
                            @if (in_array(286, $array_accesos))
                                <button type="button" name="btn-relacionar-a-oc-softlink" id="btn-relacionar-a-oc-softlink"
                                    class="btn btn-success btn-sm" title="Relacionar a OC de Softlink"
                                    onclick="listarOcSoftlink(event);" disabled><i class="fas fa-object-group"></i>
                                    Relacionar a OC de softlink</button>
                            @endif
                        ...
                        <div class="row">
                                ...
                                <select class="form-control handleChangeTipoOrden activation" name="id_tp_documento">
                                    ...
                                    @foreach ($tp_documento as $tp)
                                        @if ($tp->descripcion == 'Orden de Compra')
                                            <option value="{{ $tp->id_tp_documento }}" selected>{{ $tp->descripcion }}
                                            </option>
                                        @else
                            ...
                            <div class="col-md-1" id="group-fecha_orden">
                                ...
                                <select class="form-control activation handleChangeMoneda" name="id_moneda">
                                    @foreach ($tp_moneda as $tpm)
                                        <option value="{{ $tpm->id_moneda }}" data-simbolo-moneda="{{ $tpm->simbolo }}">
                                            {{ $tpm->descripcion }} ( {{ $tpm->simbolo }} )</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-2" id="group-fecha_emision_orden">
                                ...
                                <div style="display:flex">
                                    <input class="form-control  handleChangeFechaEmision activation" name="fecha_emision"
                            ...
                            <div class="col-md-2" id="group-datos_para_despacho-sede">
                                ...
                                <select class="form-control activation handleChangeSede" name="id_sede">
                                    @foreach ($sedes as $sede)
                                        <option value="{{ $sede->id_sede }}" data-id-empresa="{{ $sede->id_empresa }}"
                                            data-direccion="{{ $sede->direccion }}"
                                            data-id-ubigeo="{{ $sede->id_ubigeo }}"
                                            data-ubigeo-descripcion="{{ $sede->ubigeo_descripcion }}">
                                            {{ $sede->descripcion }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <h5>&nbsp;</h5>
                            <div class="col-md-2" id="group-datos_para_despacho-logo_empresa">
                                <img id="logo_empresa" src="/images/img-wide.png" alt=""
                                    style="height:56px;!important;width:100%;!important;margin-top:-20px;">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" id="group-ubigeo_proveedor" hidden>
                                ...
                                <div style="display:flex;">
                                    ...
                                    <input type="text" class="form-control" name="ubigeo_proveedor_descripcion"
                                        readOnly>
                            ...
                            <div class="col-md-2" id="group-contacto_proveedor_telefono">
                                ...
                                <div style="display:flex;">
                                    <input type="text" class="form-control" name="contacto_proveedor_telefono"
                                        readOnly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4" id="group-cuenta_bancaria_proveedor">
                                ...
                                <div style="display:flex;">
                                    ...
                                    <input type="text" class="form-control" name="moneda_cuenta_principal_proveedor"
                                        style="width:50px;" readOnly>
                                    <input type="text" class="form-control" name="nro_cuenta_principal_proveedor"
                                        readOnly>
                                    <button type="button" class="group-text" onClick="cuentasBancariasModal();">
                                        <i class="fa fa-search"></i>
                                    </button>
                                    <button type="button" class="btn-primary" title="Agregar cuenta bancaria"
                                        onClick="agregar_cuenta_proveedor();"><i class="fas fa-plus"></i></button>
                                </div>
                            </div>

                            <div class="col-md-6" id="group-rubro_proveedor">
                                <h5>Rubro</h5>
                                <select class="selectpicker" title="Elija una opción" data-width="100%"
                                    data-container="body" data-live-search="true" name="id_rubro_proveedor">
                    ...
                    <fieldset class="group-table">
                        <div class="row">
                            <div class="col-md-3" id="group-condicion_compra-forma_pago">
                                <h5>Forma de pago</h5>
                                <div style="display:flex;">
                                    <select class="form-control activation handleChangeCondicion"
                                        name="id_condicion_softlink" style="width:100%; text-align:center;">
                                        @foreach ($condiciones_softlink as $cond)
                                            <option value="{{ $cond->id_condicion_softlink }}"
                                                data-dias="{{ $cond->dias }}">{{ $cond->descripcion }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div style="display:none;">
                                    <select class="form-control group-elemento activation" name="id_condicion"
                                        ...
                                        @foreach ($condiciones as $cond)
                                            <option value="{{ $cond->id_condicion_pago }}">{{ $cond->descripcion }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <input type="number" name="plazo_dias" min="0"
                                        class="form-control group-elemento invisible"
                                        style="text-align:right; width:80px;">
                                    <input type="text" value="días" name="text_dias"
                                        class="form-control group-elemento invisible"
                            ...
                            <div class="col-md-2" id="group-condicion_compra-plazo_entrega">
                                <h5>Plazo entrega</h5>
                                <div style="display:flex;">
                                    <input type="number" name="plazo_entrega" min="0"
                                        class="form-control group-elemento activation" style="text-align:right;">
                                    <input type="text" value="días" class="form-control group-elemento"
                            ...
                            <div class="col-md-2" id="group-condicion_compra-ejecutivo_responsable" hidden>
                                ...
                                <div style="display:flex;">
                                    <input type="text" name="ejecutivo_responsable"
                                        class="form-control group-elemento" readOnly>
                                </div>
                            </div>
                                ...
                                <select class="form-control activation" name="id_tp_doc">
                                    ...
                                    @foreach ($tp_doc as $tp)
                                        @if ($tp->descripcion == 'Factura')
                                            <option value="{{ $tp->id_tp_doc }}" selected>{{ $tp->cod_sunat }} -
                                                {{ $tp->descripcion }}</option>
                                        @else
                                            <option value="{{ $tp->id_tp_doc }}">{{ $tp->cod_sunat }} -
                                                {{ $tp->descripcion }}</option>
                                        @endif
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6" id="group-datos_para_despacho-direccion_destino">
                                ...
                                <div style="display:flex;">
                                    <input type="text" name="direccion_destino"
                                        class="form-control group-elemento activation">
                                </div>
                            </div>
                            <div class="col-md-3" id="group-datos_para_despacho-ubigeo_entrega">
                                ...
                                <div style="display:flex;">
                                    ...
                                    <input type="text" name="ubigeo_destino" class="form-control group-elemento"
                                        readOnly>
                            ...
                            <div class="col-md-3" id="group-datos_para_despacho-personal_autorizado">
                                ...
                                <div style="display:flex;">
                                    ...
                                    <input type="text" name="nombre_persona_autorizado_1"
                                        class="form-control group-elemento" readOnly>
                        ...
                        <div class="row">
                            <div class="col-md-3" id="group-datos_para_despacho-personal_autorizado">
                                ...
                                <div style="display:flex;">
                                    ...
                                    <input type="text" name="nombre_persona_autorizado_2"
                                        class="form-control group-elemento" readOnly>
                            ...
                            <div class="col-md-2 text-center">
                                <div class="form-group mt-4 mb-0">
                                    <label class="label-check"><input type="checkbox" class="minimal" id="compra_local"
                                            name="compra_local"> Compras locales</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12" id="group-datos_para_despacho-observacion">
                                <h5>Observación</h5>
                                <div style="display:flex;">
                                    <textarea class="form-control activation" name="observacion" cols="100" rows="100" style="height:50px;"
                                        disabled></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <fieldset class="group-importes">
                            ...
                            <div class="btn-group" role="group" aria-label="...">
                                @if (in_array(Auth::user()->id_usuario, [3, 17, 27, 1, 77]))
                                    <button type="button"
                                        class="btn btn-xs btn-success activation handleClickCatalogoProductosModal"
                                        id="btnAgregarProducto" data-toggle="tooltip" data-placement="bottom"
                                        title="Agregar producto"><i class="fas fa-plus"></i> Productos</button>
                                @endif
                                <button type="button"
                                    class="btn btn-xs btn-info activation handleClickCatalogoProductosObsequioModal"
                                    id="btnAgregarProductoObsequio" data-toggle="tooltip" data-placement="bottom"
                                    title="Agregar producto para obsequio"><i class="fas fa-plus"></i> Productos para
                                    obsequio</button>
                                <button type="button"
                                    class="btn btn-xs btn-primary activation handleClickAgregarServicio"
                                    id="btnAgregarServicio" data-toggle="tooltip" data-placement="bottom"
                                    title="Agregar servicio"><i class="fas fa-plus"></i> Servicio</button>
                                <button type="button"
                                    class="btn btn-xs btn-default activation handleClickVincularRequerimientoAOrdenModalOLD"
                                    onClick="openVincularRequerimientoConOrden();" id="btnAgregarVinculoRequerimiento"
                                    data-toggle="tooltip" data-placement="bottom"
                                    title="Agregar items de otro requerimiento" disabled><i class="fas fa-plus"></i>
                                    Vincular otro requerimiento
                                </button>
                            </div>
                            <table class="table table-striped table-condensed table-bordered" id="listaDetalleOrden"
                                width="100%">
                                <thead>
                                    <tr>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-right"><span name="simboloMoneda">S/</span><label
                                                name="montoNeto"> 0.00</label></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td colspan="11" class="text-right">
                                            <input class="activation handleClickIncluyeIGV" type="checkbox"
                                                name="incluye_igv" checked> <strong>Incluye IGV</strong>
                                        </td>
    ...
    <div class="hidden" id="divOculto">
        <select id="selectUnidadMedida">
            @foreach ($unidades_medida as $unidad)
                <option value="{{ $unidad->id_unidad_medida }}" {{ $unidad->id_unidad_medida == '1' ? 'selected' : '' }}>
                    {{ $unidad->abreviatura }}</option>
            @endforeach
        </select>
    </div>
    <div class="hidden">
        ...
        <select name="selectEmpresa">
            @foreach ($empresas as $empresa)
                @if ($empresa->id_empresa == 1)
                    <option value="{{ $empresa->id_empresa }}" data-codigo-empresa="{{ $empresa->codigo }}" selected>
                        {{ $empresa->razon_social }}</option>
                @else
                    <option value="{{ $empresa->id_empresa }}" data-codigo-empresa="{{ $empresa->codigo }}">
                        {{ $empresa->razon_social }}</option>
                @endif
            @endforeach
        </select>
...
@section('scripts')
    ...
    <script src="{{ asset('template/adminlte2-4/plugins/datatables/extensions/Buttons/js/buttons.html5.min.js') }}">
    </script>
    ...
    <script
        src="{{ '/js/logistica/proveedores/listaProveedoresModal.js' }}?v={{ filemtime(public_path('/js/logistica/proveedores/listaProveedoresModal.js')) }}">
    </script>
    <script
        src="{{ '/js/logistica/proveedores/cuentasBancariasProveedor.js' }}?v={{ filemtime(public_path('/js/logistica/proveedores/cuentasBancariasProveedor.js')) }}">
    </script>
    <script
        src="{{ '/js/logistica/add_proveedor.js' }}?v={{ filemtime(public_path('/js/logistica/add_proveedor.js')) }}">
    </script>
    <script src="{{ asset('js/publico/ubigeoModal.js') }}?v={{ filemtime(public_path('js/publico/ubigeoModal.js')) }}">
    </script>
    <script
        src="{{ '/js/logistica/proveedores/proveedorContactoModal.js' }}?v={{ filemtime(public_path('/js/logistica/proveedores/proveedorContactoModal.js')) }}">
    </script>
    <script
        src="{{ '/js/logistica/orden/trabajadorModal.js' }}?v={{ filemtime(public_path('/js/logistica/orden/trabajadorModal.js')) }}">
    </script>
    <script
        src="{{ asset('js/publico/consulta_sunat.js') }}?v={{ filemtime(public_path('js/publico/consulta_sunat.js')) }}">
    </script>
    <script src="{{ '/js/logistica/orden/orden.js' }}?v={{ filemtime(public_path('/js/logistica/orden/orden.js')) }}">
    </script>
    <script
        src="{{ '/js/logistica/orden/relacionarOcSoftlink.js' }}?v={{ filemtime(public_path('/js/logistica/orden/relacionarOcSoftlink.js')) }}">
    </script>
    <script
        src="{{ '/js/logistica/orden/vincularRequerimientoConOrdenModal.js' }}?v={{ filemtime(public_path('/js/logistica/orden/vincularRequerimientoConOrdenModal.js')) }}">
    </script>
@endsection
