...
function listar() {
    ...
    $('#lista-modelos').DataTable({
        ...
        'columns': [
            { 'data': 'id_cas_modelo', 'name': 'id_cas_modelo'},
            { 'data': 'id_cas_modelo', 'name': 'id_cas_modelo',
                    ...
                    function (data, type, row) {
                        return `
                            <div class="btn-group" role="group">
                                ...
                                data-placement="bottom" data-id="${row['id_cas_modelo']}" title="Editar registro" >
                                <i class="fas fa-edit"></i></button>

                                <button type="button" class="anular btn btn-danger boton" data-toggle="tooltip"
                                data-placement="bottom" data-id="${row['id_cas_modelo']}" title="Anular registro" >
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            if (result.value.status===200) {
                $('#nuevo').modal('hide');
                $('#lista-modelos').DataTable().ajax.reload();
                Swal.fire({
                    title: 'Éxito',
