            ...
            { 'data': 'estado' },
            {
                'render':
                    function (data, type, row, meta) {
                        return ('<div class="text-center"><button type="button" class="btn btn-sm btn-danger btn-flat botonList" data-toggle="tooltip" data-placement="bottom" title="Anular" onClick="anularDocumento(' + row['id'] + ');"><i class="fas fa-ban"></i></button>');
                    }
            }
        ],
        'order': [
