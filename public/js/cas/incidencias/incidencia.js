...
function mostrarIncidencia(id) {
    $.ajax({
        ...
        success: function (response) {
            ...
            $(`select[name="marca"]`).val(response.incidencia.marca).trigger('change.select2');
            $(`select[name="modelo"]`).val(response.incidencia.modelo).trigger('change.select2');
            $(`select[name="producto"]`).val(response.incidencia.producto).trigger('change.select2');
